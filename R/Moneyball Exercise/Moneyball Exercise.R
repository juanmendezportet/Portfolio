...
#After filtering and analyzing the data, I decided that best replacement 
...
#These players were chosen by focusing on their statistics vis-a-vis their salaries. 
#All three players have, if not better, an on par overall performance compared with 
#the players leaving the team, and much lower salaries. This is shown explicitly throughout 
#the code and can ultimately be seen represented in the chart. I used batting data
#from all years before the year 2002 and the salary data for the year 2001 (The year of the signings).
#After filtering for the players that had higher average statistics than the players leaving
#I carefully examined different options to make sure the data was correct, this meaning,
#they had enough data to make an informed decision. 

#In conclusion, I lowered the money spent in salaries from 11,493,333 to 745,000 while
